...
Chargeback and disputes details per payment method:

<AccordionGroup>
  <Accordion title="Cards (Visa, Mastercard, Maestro, V PAY)" icon="credit-card" iconType="regular">
  ...
  <Accordion title="iDEAL" icon="sparkles">
